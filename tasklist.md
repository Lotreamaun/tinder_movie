...
|----------|--------|----------|------------------|------------|
| 1 | 🔄 В процессе | 0% | - | Настройка проекта |
| 2 | ⏳ Ожидает | 0% | - | Базовая структура |
| 3 | ⏳ Ожидает | 0% | - | Telegram бот |
...
- [ ] Настроить Python окружение (venv)
...
- [ ] Создать main.py с FastAPI приложением
- [ ] Настроить CORS для фронтенда
- [ ] Создать базовый health check endpoint
- [ ] Настроить структуру папок (models, api, services)
- [ ] Создать config.py для настроек
...
- [ ] Создать bot/handlers.py с базовыми командами
